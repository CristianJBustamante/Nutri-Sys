...
!(function (a) {
    ...
    function ea(c, d, e) {
        ...
        return (
            b.isMoment(j)
                ...
                : ((f = !1),
                  (g = !1),
                  k ? (Za.test(j) ? ((j += "-01"), (c = [j]), (f = !0), (g = !0)) : (h = $a.exec(j)) && ((f = !h[5]), (g = !0))) : a.isArray(j) && (g = !0),
    ...
    function Ja(c, d) {
        ...
        (P._fullCalendar_weekCalc = (function (a) {
            ...
            (N.moment = function () {
                var a;
                return (
                    "local" === O.timezone ? ((a = Pa.moment.apply(null, arguments)), a.hasTime() && a.local()) : (a = "UTC" === O.timezone ? Pa.moment.utc.apply(null, arguments) : Pa.moment.parseZone.apply(null, arguments)),
    ...
    function Na(c) {
        ...
        function x(b, c, d) {
            ...
            return (
                ...
                u(c),
                (f = { start: b._start.clone(), end: b._end ? b._end.clone() : K.getDefaultEventEnd(b._allDay, b._start), allDay: c.allDay }),
                u(f),
    ...
    var Ta = ["Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado"],
        ...
        (_a.isSame = function (a, b) {
            ...
            return this._fullCalendar
                ? b
                    ...
                    : ((a = Pa.moment.parseZone(a)), ab.isSame.call(this, a) && Boolean(this._ambigTime) === Boolean(a._ambigTime) && Boolean(this._ambigZone) === Boolean(a._ambigZone))
        ...
        hb = (Pa.DragListener = ra.extend({
            ...
            startListening: function (b) {
                ...
                this.isListening ||
                    (b &&
                        this.options.scroll &&
                        ((c = n(a(b.target))), c.is(window) || c.is(document) || ((this.scrollEl = c), (this.scrollHandlerProxy = da(ca(this, "scrollHandler"), 100)), this.scrollEl.on("scroll", this.scrollHandlerProxy))),
                    a(document)
                ...
                hb.prototype.listenStart.apply(this, arguments),
                    ...
                    a
                        ? ((c = { left: a.pageX, top: a.pageY }),
                          ...
                          e && this.options.subjectCenter && (this.origHit && (b = w(this.origHit, b) || b), (d = y(b))),
            ...
            return (
                g.hasTime() === h.hasTime()
                    ? ((d = this.diffDates(h, g)),
                      c.allDay && N(d) ? ((e = { start: c.start.clone(), end: f.getEventEnd(c), allDay: !1 }), f.normalizeEventTimes(e)) : (e = { start: c.start.clone(), end: c.end ? c.end.clone() : null, allDay: c.allDay }),
                      e.start.add(d),
                      e.end && e.end.add(d))
        ...
        eventsToSegs: function (b, c) {
            ...
            return (
                a.each(e, function (a, b) {
                    ...
                    if (xa(b[0])) for (g = d.invertRanges(g), e = 0; e < g.length; e++) f.push.apply(f, d.eventRangeToSegs(g[e], b[0], c));
    ...
    var nb = (Pa.TimeGrid = kb.extend(lb, {
        ...
        sliceRangeByTimes: function (a) {
            var b,
                ...
                e,
                f = [];
            for (c = 0; c < this.daysPerRow; c++) (d = this.dayDates[c].clone()), (e = { start: d.clone().time(this.minTime), end: d.clone().time(this.maxTime) }), (b = E(a, e)), b && ((b.dayIndex = c), f.push(b));
            return f;
        },
        ...
        fgSegHtml: function (a, b) {
            ...
            return (
                ...
                '<a class="' +
                    ...
                    (l ? ' style="' + l + '"' : "") +
                    '><div class="fc-content">' +
                    (c ? '<div class="fc-time" data-start="' + Y(e) + '" data-full="' + Y(d) + '"><span>' + Y(c) + "</span></div>" : "") +
        ...
        pb = (Pa.Calendar = ra.extend({
            ...
            buildViewSpec: function (a) {
                ...
                return (
                    ...
                    (d.type = a),
                    d["class"]
                        ? (f && ((f = b.duration(f)), f.valueOf() && ((d.duration = f), (g = I(f)), 1 === f.as(g) && ((d.singleUnit = g), k.unshift(h[g] || {})))),
                          (d.defaults = c(j)),
                          (d.overrides = c(k)),
    ...
    pb.mixin(eb),
        (pb.defaults = {
            ...
            timezone: !1,
            isRTL: !1,
            buttonText: { prev: "prev", next: "next", prevYear: "prev year", nextYear: "next year", year: "year", today: "hoy", month: "mes", week: "semana", day: "día" },
            ...
            setHeight: function (a, b) {
                ...
                null === this.bottomRuleHeight && (this.bottomRuleHeight = this.bottomRuleEl.outerHeight()),
                    ...
                    b ||
                        ...
                        l(this.scrollerEl, d) ? (e(this.noScrollRowEls, r(this.scrollerEl)), (d = this.computeScrollerHeight(a)), this.scrollerEl.height(d)) : (this.scrollerEl.height(d).css("overflow", "hidden"), this.bottomRuleEl.show()));
            },
        ...
        Ab = {
            renderHeadIntroHtml: function () {
                ...
                return b.opt("weekNumbers")
                    ? ((a = this.start.format(b.opt("smallWeekFormat"))), '<th class="fc-axis fc-week-number ' + b.widgetHeaderClass + '" ' + b.axisStyleAttr() + "><span>" + Y(a) + "</span></th>")
    ...
    return (
        (Qa.agenda = { class: zb, defaults: { allDaySlot: !0, allDayText: "all-day", slotDuration: "00:30:00", minTime: "00:00:00", maxTime: "24:00:00", slotEventOverlap: !0 } }),
