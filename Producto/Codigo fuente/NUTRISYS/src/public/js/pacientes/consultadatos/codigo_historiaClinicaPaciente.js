...
const mostrarData = (data) => {
    console.log(data) 
    let solapas=''
    solapas=`<a class="resumen__solapa"  href="../consultapacientefichainicial/hc=${data.pac_nrohc}">Ficha Inicial</a><a class="resumen__solapa--seleccionado" href="../consultapaciente/hc=${data.pac_nrohc}">Resumen</a><a class="resumen__solapa" href="../consultapacienteevolucion/hc=${data.pac_nrohc}">Hábitos</a><a class="resumen__solapa" href="../consultapacientefichas/hc=${data.pac_nrohc}">Fichas</a><a class="resumen__solapa" href="../consultapacienteplan/hc=${data.pac_nrohc}">Planes</a><a class="resumen__solapa" href="../consultapacientedocumentos/hc=${data.pac_nrohc}">Documentos</a><a class="resumen__solapa" href="../consultapacienteestudios/hc=${data.pac_nrohc}">Estudios</a><a class="resumen__solapa--resto"></a>`        
