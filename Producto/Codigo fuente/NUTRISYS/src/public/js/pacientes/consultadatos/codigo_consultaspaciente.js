...
const mostrarData = (data) => {
    ...
    <a class="nav__solapa" href="/pacientes/consultapacientefichas/hc=${data.pac_nrohc}">Evoluciones</a>
    <a class="nav__solapa--seleccionado" href="../consultapacienteplan/hc=${data.pac_nrohc}">Consultas</a>
