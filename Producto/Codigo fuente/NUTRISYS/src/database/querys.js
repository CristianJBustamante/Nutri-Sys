...
//PACIENTES
    ...
    getPacienteXHC: 'SELECT *,convert(varchar,pac_fechanacimiento,103) as pac_fechanac,convert(varchar,pac_fechanacimiento,23) as pac_fnac FROM paciente WHERE pac_nrohc = @pac_nrohc',
